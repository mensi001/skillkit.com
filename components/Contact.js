        ...
        <>
            ...
            <div className="fixed bottom-6 left-6 z-50">
                <button
                    ...
                    className="w-16 h-16 rounded-full bg-amber-500 hover:bg-amber-400 text-black shadow-lg shadow-amber-500/20 flex items-center justify-center transition-transform hover:scale-110"
                    title="Contact Us"
                >
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <a
                    ...
                    className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-400 text-white shadow-lg shadow-green-500/20 flex items-center justify-center transition-transform hover:scale-110"
