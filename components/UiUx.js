...
export default function LatestCourse() {
  return (
    <section className="py-24 bg-black" id="courses">
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div style={{ marginLeft: 'auto' }}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            UI/UX Design <br /> with AI
          </h2>

          <p className="text-gray-400 max-w-lg mb-8">
            Learn modern UI/UX design combined with AI tools. Interactive projects,
            real-world workflows, and future-ready skills.
          </p>

          <div className="flex flex-wrap gap-2 mb-8">
            {["Figma", "Photoshop", "illustrator", "figma's plugin", "ChatGPT", "Gemini"].map(tool => (
              <span
                key={tool}
          ...
          {/* <button className="px-8 py-3 rounded-full bg-amber-500 text-black font-semibold hover:bg-amber-400 transition">
            View Course
          </button> */}
        </div>
